        ...
        <div style={{ width: "100%", maxWidth: 420, animation: "fadeUp 0.5s ease" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            <div style={{
              ...
              boxShadow: "0 0 40px rgba(232,115,138,0.35), 0 0 80px rgba(232,115,138,0.15)",
          ...
          <div style={{
            ...
            border: "1px solid rgba(232,115,138,0.15)",
            ...
            <div style={{ marginBottom: 18 }}>
              ...
              <input
                ...
                style={{ width: "100%", padding: "12px 16px", background: "rgba(255,255,255,0.04)", border: "1.5px solid rgba(232,115,138,0.15)", borderRadius: 10, fontSize: 14, fontFamily: "'DM Sans', sans-serif", transition: "all 0.2s", boxSizing: "border-box" }}
              />
            </div>
            ...
            <div style={{ marginBottom: 28 }}>
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  onKeyDown={e => e.key === "Enter" && handleLogin()}
                  placeholder="••••••••"
                  style={{ width: "100%", padding: "12px 44px 12px 16px", background: "rgba(255,255,255,0.04)", border: "1.5px solid rgba(232,115,138,0.15)", borderRadius: 10, fontSize: 14, fontFamily: "'DM Sans', sans-serif", transition: "all 0.2s", boxSizing: "border-box" }}
                />
            ...
            <button onClick={handleLogin} disabled={loading} style={{
              ...
              background: loading ? "rgba(232,115,138,0.3)" : "linear-gradient(135deg, #c94f68, #e8738a)",
              border: "none", borderRadius: 10, color: "#fff",
              fontSize: 14, fontWeight: 700, cursor: loading ? "not-allowed" : "pointer",
              fontFamily: "'DM Mono', monospace", letterSpacing: 0.5,
              boxShadow: loading ? "none" : "0 8px 24px rgba(232,115,138,0.35)",
              transition: "all 0.2s",
            }}>
